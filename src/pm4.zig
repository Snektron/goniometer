...
pub const Register = enum(u16) {
    ...
    fn address(self: Register) u16 {
        return (@enumToInt(self) - 0xB000) / @sizeOf(u32);
    }
};

pub const IndirectBuffer = packed struct(u128) {
    swap: u2,
    ib_base_lo: u30,
    ib_base_hi: u16,
    _reserved0: u16 = 0,
...
pub const Opcode = enum(u8) {
    ...
    cond_indirect_buffer_cnst                    = 0x33,
    ...
    dispatch_draw_preamble_ace__gfx09            = 0x8c,
    dispatch_draw__gfx09                         = 0x8d,
    dispatch_draw_ace__gfx09                     = 0x8d,
